...
public class UsuarioFragment extends Fragment {
    ...
    public static UsuarioFragment newInstance(int sectionNumber) {
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            switch (position){
                case 0:
                    return  new DatosPersonalFragment();
                case 1:
                    return  new DatosFisicoFragment();
        ...
        public CharSequence getPageTitle(int position) {
            ...
            return getResources().getStringArray(R.array.tabs_usuario)[position].toUpperCase(l);
