...
public class ReportesFragment extends Fragment {
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            switch (position){
                case 0:
                    return  new ReporteCompletoFragment();
                case 1:
                    return  new ReporteExamenesFragment();
                case 2:
                    return  new ReporteResumenFragment();
                default:
                    return null;
            }
        }
        ...
        public CharSequence getPageTitle(int position) {
            ...
            return getResources().getStringArray(R.array.tabs_reportes)[position].toUpperCase(l);
