...
public class MainActivity extends ActionBarActivity implements OnButtonPressedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Eventos
        NavItms.add(new Menu_Item(titulos[3], NavIcons.getResourceId(2, -1)));
        //Lugares
        NavItms.add(new Menu_Item(titulos[4], NavIcons.getResourceId(3, -1)));
        //Etiquetas
        NavItms.add(new Menu_Item(titulos[5], NavIcons.getResourceId(4, -1)));
        //Configuracion
...
//                        .commit();
    ...
    public void onSectionAttached(int number) {
        ...
        mTitle = getResources().getStringArray(R.array.nav_options)[number];
        /*switch (number) {
            case 1:
